      ...
      <Table>
        <TableHeader>
          <TableRow className="border-t text-base [&>th]:h-auto [&>th]:py-3 sm:[&>th]:py-4.5">
            ...
            {role !== "team" && <TableHead className="pr-5 text-right sm:pr-6 xl:pr-7.5">Action</TableHead>}
          </TableRow>
        </TableHeader>
        ...
        <TableBody>
          {Array.isArray(category) ? category.map((category: any) => (
            ...
            <TableRow>
              <TableCell colSpan={role !== "team" ? 2 : 1} className="text-center py-4 text-muted-foreground">
                No Categories found.
              </TableCell>
            </TableRow>
          )}
